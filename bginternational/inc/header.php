                ...
                <div class="main-menu-wrapper__main-menu">
                    ...
                    <ul class="main-menu__list">
                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                <li><a href="property-advisors.php">BGI Property Advisors</a></li>
                                <li><a href="general-trading.php">BGI General Trading</a></li>
                                <li><a href="advertising.php">BGI Advertising</a></li>
                            </ul>
                        </li>
